...
/*handling how rooms get choosen and pricing towards the end of the page */
function roomPrices(){
    var guestName = document.getElementById('guestName').value;
    var numOfRooms = document.getElementById('amountRoom').value;
    var phoneNum = document.getElementById('contactInfo').value;
    
    /*Lux single bed choice and the options that go with it*/
    ...
    /*Moderate single bed choice and the options that go with it*/
    ...
    /*Lux Bouble bed choice and the options that go with it*/
    ...
    /*This will print a receipt to the screen in the form of a popup box */
